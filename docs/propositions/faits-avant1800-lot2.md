...
>
> **Où en est cette zone** : 147 faits avant J.-C. sur 1 763, dont
> **6 seulement de niveau 1** et 95 de niveau 3 — c'est la partie la plus
> pointue de toute la base, alors que c'est là que la frise est la plus
> vide.
>
> **Validation** : par la page à cocher, pas ici. Ce fichier reste la trace.
>
> ⚠️ **Contrôle anti-doublon renforcé** après les six ratés du lot 1 :
> chaque titre est comparé mot à mot à toute la base, et tout fait situé à
> moins de cinq ans d'un candidat est signalé. Huit propositions ont été
> écartées à ce stade — jardins de Babylone, Carthage rasée, Chartres,
> Gengis Khan, Européens au Japon, séisme de Lisbonne, Cook en Australie,
> vol en montgolfière : toutes existaient déjà.

---

## Avant J.-C. — 25 faits

### B1 · -2800 — L'invention du savon
| | |
|---|---|
| annee | -2800 |
| desc | En Mésopotamie, on fait bouillir des graisses avec des cendres pour obtenir une pâte qui décrasse le linge et les mains. |
| emoji | 🧼 |
| niveau | 2 |
...
|---|---|
| annee | -2500 |
| desc | En Égypte, un verrou de bois à chevilles mobiles ne s'ouvre qu'avec une longue clé de bois taillée exprès : le premier vrai secret gardé. |
| emoji | 🔑 |
| niveau | 2 |
...
|---|---|
| annee | -2400 |
| desc | Des jarres égyptiennes conservent une pâte blanche obtenue en faisant cailler le lait : le fromage est déjà un aliment de tous les jours. |
| emoji | 🧀 |
| niveau | 1 |
...
|---|---|
| annee | -2000 |
| desc | On polit des disques de bronze jusqu'à y voir son reflet : se regarder devient possible ailleurs que dans l'eau. |
| emoji | 🪞 |
| niveau | 2 |
...
|---|---|
| annee | -1500 |
| desc | Sur la côte du Levant, on écrase des milliers de coquillages pour obtenir une teinture rouge violacée qui ne déteint jamais. |
| emoji | 🐚 |
| niveau | 3 |
...
|---|---|
| annee | -1400 |
| desc | Un vase percé laisse fuir l'eau à débit constant : pour la première fois, on mesure le temps la nuit et par temps couvert. |
| emoji | ⏳ |
| niveau | 2 |
...
|---|---|
| annee | -1200 |
| desc | En Chine, on tend de la soie sur un cadre de bambou et on la laisse monter au bout d'une ficelle. |
| emoji | 🪁 |
| niveau | 2 |
...
|---|---|
| annee | -800 |
| desc | Un aède grec fixe deux longs poèmes récités de mémoire : la guerre autour d'une cité assiégée, puis le retour interminable d'un héros. |
| emoji | 📜 |
| niveau | 2 |
...
|---|---|
| annee | -700 |
| desc | On découvre qu'un pigeon relâché loin de chez lui y revient toujours : les nouvelles vont soudain plus vite que les chevaux. |
| emoji | 🕊️ |
| niveau | 2 |
...
|---|---|
| annee | -600 |
| desc | Un médecin indien décrit comment reconstruire un nez avec un lambeau de peau prélevé sur le front du patient. |
| emoji | 🩺 |
| niveau | 3 |
...
|---|---|
| annee | -530 |
| desc | Un savant grec et ses disciples démontrent une règle sur les triangles rectangles qui sera récitée par tous les écoliers du monde. |
| emoji | 📐 |
| niveau | 2 |
...
|---|---|
| annee | -500 |
| desc | Au cœur de l'Afrique de l'Ouest, des artisans modèlent des têtes d'argile aux yeux triangulaires, hautes comme un enfant. |
| emoji | 🗿 |
| niveau | 3 |
...
|---|---|
| annee | -500 |
| desc | Un stratège chinois résume en treize chapitres comment gagner une bataille — de préférence sans la livrer. |
| emoji | 🎋 |
| niveau | 2 |
...
|---|---|
| annee | -450 |
| desc | Un Grec voyage d'Égypte en mer Noire pour interroger les témoins et écrire ce qui s'est passé, plutôt que ce qu'on raconte. |
| emoji | 🧭 |
| niveau | 2 |
...
|---|---|
| annee | -400 |
| desc | Partout autour de la Méditerranée, les enfants lancent en l'air de petits os de mouton et tentent de les rattraper sur le dos de la main. |
| emoji | 🎲 |
| niveau | 2 |
...
|---|---|
| annee | -350 |
| desc | Un philosophe grec dissèque, observe et classe des centaines d'espèces : c'est le premier grand livre de sciences naturelles. |
| emoji | 🐙 |
| niveau | 2 |
...
|---|---|
| annee | -221 |
| desc | Le premier empereur de Chine fait relier entre eux les murs de terre des anciens royaumes pour barrer la route aux cavaliers du nord. |
| emoji | 🧱 |
| niveau | 1 |
...
|---|---|
| annee | -200 |
| desc | Privée de papyrus égyptien, une cité d'Asie Mineure met au point une peau de mouton poncée si fine qu'on écrit des deux côtés. |
| emoji | 📃 |
| niveau | 2 |
...
|---|---|
| annee | -200 |
| desc | Une caisse montée sur une seule roue permet à un homme seul de déplacer la charge de trois porteurs. |
| emoji | 🛒 |
| niveau | 2 |
...
|---|---|
| annee | -200 |
| desc | Des boules coulissant sur des tiges de bambou permettent d'additionner et de multiplier plus vite qu'en écrivant. |
| emoji | 🧮 |
| niveau | 1 |
...
|---|---|
| annee | -100 |
| desc | Un atelier grec assemble trente engrenages de bronze dans un boîtier de bois capable de prédire la position des astres et la date des éclipses. |
| emoji | ⚙️ |
| niveau | 3 |
...
|---|---|
| annee | -100 |
| desc | Une roue plongée dans un courant fait tourner une meule : pour la première fois, une machine remplace la force des bras pour moudre le grain. |
| emoji | 💧 |
| niveau | 2 |
...
|---|---|
| annee | -50 |
| desc | Sur la côte syrienne, un artisan souffle dans une canne creuse et façonne une bulle de verre : les récipients deviennent rapides à produire, donc bon marché. |
| emoji | 🫧 |
| niveau | 2 |
...
|---|---|
| annee | -30 |
| desc | Pendant les combats qui secouent la ville, un incendie ravage une partie de la plus grande collection de rouleaux du monde antique. |
| emoji | 🔥 |
| niveau | 2 |
...
|---|---|
| annee | -5 |
| desc | Des ateliers romains moulent en masse de petites lampes de terre cuite : la lumière du soir cesse d'être un privilège. |
| emoji | 🪔 |
| niveau | 3 |
...
## De l’an 1 à 1800 — 15 faits

### C1 · 50 — Le pont du Gard enjambe la vallée
| | |
|---|---|
| annee | 50 |
| desc | Pour porter l'eau jusqu'à une ville romaine, des ingénieurs empilent trois rangées d'arches sur près de cinquante mètres de haut, sans mortier. |
| emoji | 🌉 |
| niveau | 1 |
...
|---|---|
| annee | 79 |
| desc | À Rome, jusqu'à 150 000 spectateurs hurlent pour les écuries rouge, blanche, verte et bleue, dont les couleurs divisent la ville entière. |
| emoji | 🏇 |
| niveau | 2 |
...
|---|---|
| annee | 300 |
| desc | Sur des stèles de pierre, des scribes gravent des signes qui notent à la fois des sons et des mots : la seule écriture complète des Amériques anciennes. |
| emoji | 🔤 |
| niveau | 2 |
...
|---|---|
| annee | 610 |
| desc | Des potiers chinois cuisent une argile blanche à si haute température qu'elle devient dure, fine et translucide. |
| emoji | 🏺 |
| niveau | 2 |
...
|---|---|
| annee | 650 |
| desc | Les révélations transmises oralement sont rassemblées en un livre unique, dont des copies sont envoyées aux grandes villes de l'empire. |
| emoji | 📗 |
| niveau | 2 |
...
|---|---|
| annee | 700 |
| desc | Venu d'Inde avec ses éléphants et ses chars, un jeu de guerre sur damier séduit la cour perse, qui lui donne le nom de son roi. |
| emoji | ♟️ |
| niveau | 2 |
...
|---|---|
| annee | 800 |
| desc | Un disque de laiton gravé permet de lire l'heure, de trouver le nord et de calculer la hauteur des étoiles, tout cela d'une seule main. |
| emoji | 🔮 |
| niveau | 2 |
...
|---|---|
| annee | 850 |
| desc | On raconte qu'un berger d'Abyssinie remarque que ses chèvres ne dorment plus après avoir brouté les baies rouges d'un arbuste. |
| emoji | ☕ |
| niveau | 2 |
...
|---|---|
| annee | 1000 |
| desc | En Chine, on bourre des tubes de bambou de poudre noire : le ciel des fêtes s'illumine et claque. |
| emoji | 🎆 |
| niveau | 1 |
...
|---|---|
| annee | 1370 |
| desc | Une ordonnance fixe la recette : huile d'olive, cendres de plantes marines, et rien d'autre. Le savon devient une industrie. |
| emoji | 🫧 |
| niveau | 2 |
...
|---|---|
| annee | 1440 |
| desc | Un souverain aztèque fait planter à flanc de colline des espèces venues de tout son empire, soignées par des jardiniers spécialisés. |
| emoji | 🌺 |
| niveau | 3 |
...
|---|---|
| annee | 1533 |
| desc | Une princesse italienne apporte dans ses bagages un petit ustensile à deux dents pour porter la nourriture à la bouche sans se salir les doigts. |
| emoji | 🍴 |
| niveau | 2 |
...
|---|---|
| annee | 1602 |
| desc | Des navires hollandais rapportent de Chine des caisses de feuilles séchées qu'on fait infuser : une boisson chaude nouvelle entre dans les salons. |
| emoji | 🍵 |
| niveau | 2 |
...
|---|---|
| annee | 1608 |
| desc | Un lunetier des Pays-Bas aligne deux verres dans un tube et découvre que les objets lointains paraissent tout proches. |
| emoji | 🔭 |
| niveau | 2 |
...
|---|---|
| annee | 1653 |
| desc | Après vingt ans de travaux, un empereur moghol termine le mausolée de marbre blanc bâti pour son épouse morte en couches. |
| emoji | 🕌 |
| niveau | 1 |
