...
> Afrique 6 — le mode Facile n'a presque rien à jouer.
>
> **Comment valider** : remplis la ligne `Verdict` de chaque fait —
> `oui`, `non`, ou une correction en toutes lettres. Seuls les « oui »
> seront intégrés à `assets/events.json`, avec les tests relancés.
>
> **Ce qui a été vérifié avant de te les proposer** : chaque fait a été
> confronté à la base (aucun doublon avec les 1 738 existants — plusieurs
> candidats évidents comme les billets de banque chinois, la draisienne ou
> la poubelle y étaient déjà) ; aucune description ne contient d'indice de
> date ; chaque année vient d'une source établie. Conformément à la règle
> d'écriture ajoutée à SPEC §1 : 24 faits sur 40 sont antérieurs à 1900,
> 25 sur 40 se passent hors d'Europe.
>
> **Sur les niveaux** : j'ai noté « connu des enfants » (niveau 1) quand le
> SUJET est familier d'un enfant de 10 ans (Naruto, le T. rex, Big Ben),
> même si l'événement précis ne l'est pas — c'est le critère qu'utilise la
> base (« Sortie de Super Mario Bros » est niveau 1). Corrige librement.

---

## Pack Asie *(12 faits — le pack passe de 2 à 7 faits de niveau 1)*

### A1 · 752 — Le Grand Bouddha de Nara
| | |
|---|---|
| annee | 752 |
| desc | Au Japon, une statue de bronze doré haute comme un immeuble de cinq étages est consacrée dans le plus grand bâtiment en bois du monde. |
| emoji | 🧘 |
| niveau | 2 |
...
|---|---|
| annee | 1869 |
| desc | Dans les montagnes de Chine, un missionnaire naturaliste français décrit un « ours blanc et noir » inconnu des scientifiques. |
| emoji | 🐼 |
| niveau | 2 |
...
|---|---|
| annee | 1882 |
| desc | Un jeune professeur japonais transforme les techniques de combat des samouraïs en une « voie de la souplesse » où l'on apprend aussi à tomber. |
| emoji | 🥋 |
| niveau | 1 |
...
|---|---|
| annee | 1952 |
| desc | Un dessinateur japonais donne vie à un petit robot volant au grand cœur, héros d'une bande dessinée qui va conquérir le monde. |
| emoji | 🤖 |
| niveau | 2 |
...
|---|---|
| annee | 1954 |
| desc | Un monstre marin géant, réveillé par des essais nucléaires, écrase Tokyo sur les écrans japonais. |
| emoji | 🦖 |
| niveau | 2 |
...
|---|---|
| annee | 1958 |
| desc | À Osaka, un restaurateur inspiré par les tapis roulants d'une brasserie fait défiler les assiettes devant les clients. |
| emoji | 🍣 |
| niveau | 1 |
...
|---|---|
| annee | 1964 |
| desc | Pour la première fois, la flamme olympique est allumée sur le continent asiatique, dans une capitale entièrement modernisée pour l'occasion. |
| emoji | 🔥 |
| niveau | 2 |
...
|---|---|
| annee | 1971 |
| desc | Un musicien japonais construit une machine qui joue l'accompagnement des chansons — à chacun de poser sa voix dessus. |
| emoji | 🎤 |
| niveau | 2 |
...
|---|---|
| annee | 1988 |
| desc | Deux petites filles emménagent à la campagne et rencontrent un esprit de la forêt, rond, gris et géant, dans un film d'animation japonais. |
| emoji | 🌳 |
| niveau | 1 |
...
|---|---|
| annee | 1997 |
| desc | Un jeune pirate au chapeau de paille, au corps élastique, part chercher le plus grand trésor du monde dans un manga au long cours. |
| emoji | 🏴‍☠️ |
| niveau | 1 |
...
|---|---|
| annee | 1999 |
| desc | Un jeune ninja turbulent, rêvant de devenir le chef de son village, fait ses débuts dans un manga. |
| emoji | 🍥 |
| niveau | 1 |
...
## Pack Afrique & Moyen-Orient *(7 faits)*

### F1 · 969 — Fondation du Caire
| | |
|---|---|
| annee | 969 |
| desc | Au bord du Nil, une dynastie venue de l'ouest fonde une ville nouvelle appelée « La Victorieuse », promise à devenir la plus grande d'Afrique. |
| emoji | 🌙 |
| niveau | 2 |
...
|---|---|
| annee | 1704 |
| desc | Un savant français commence à traduire un recueil de contes venus d'Orient : Shéhérazade, Aladdin et Ali Baba vont conquérir l'Occident. |
| emoji | 🪔 |
| niveau | 2 |
...
|---|---|
| annee | 1827 |
| desc | Offerte au roi de France par le maître de l'Égypte, une girafe débarque à Marseille et rejoint Paris à pied, saluée par des foules immenses. |
| emoji | 🦒 |
| niveau | 2 |
...
|---|---|
| annee | 1841 |
| desc | Sur l'île Bourbon, un jeune esclave découvre le geste qui féconde la fleur de vanille — ce que les savants d'Europe cherchaient en vain. |
| emoji | 🌼 |
| niveau | 2 |
...
|---|---|
| annee | 1992 |
| desc | Au Nigeria, un film tourné en vidéo et vendu directement en cassettes lance une industrie du cinéma qui deviendra l'une des plus prolifiques du monde. |
| emoji | 🎬 |
| niveau | 2 |
...
|---|---|
| annee | 1995 |
| desc | Un attaquant libérien devient le premier joueur africain élu meilleur footballeur du monde. |
| emoji | ⚽ |
| niveau | 2 |
...
|---|---|
| annee | 2010 |
| desc | Pour la première fois, le plus grand tournoi de football de la planète se dispute sur le sol africain, au son des vuvuzelas. |
| emoji | 🎺 |
| niveau | 1 |
...
## Pack Amériques *(2 faits)*

### M1 · 1876 — Les Aventures de Tom Sawyer
| | |
|---|---|
| annee | 1876 |
| desc | Un gamin du Mississippi, roi de l'école buissonnière, fait repeindre sa clôture par ses copains dans un roman de Mark Twain. |
| emoji | 🎣 |
| niveau | 2 |
...
|---|---|
| annee | 1902 |
| desc | Dans les terres arides du Montana, un chasseur de fossiles déterre les os d'un gigantesque reptile carnivore encore inconnu. |
| emoji | 🦴 |
| niveau | 1 |
...
## Pack Ciel & espace *(1 fait)*

### E1 · 1968 — La Terre se lève sur la Lune
| | |
|---|---|
| annee | 1968 |
| desc | En tournant autour de la Lune, des astronautes photographient leur propre planète, petite bille bleue suspendue dans le noir. |
| emoji | 🌍 |
| niveau | 2 |
...
## Sans pack — sciences, quotidien, arts *(18 faits)*

### S1 · 1163 — La première pierre de Notre-Dame de Paris
| | |
|---|---|
| annee | 1163 |
| desc | Sur une île de la Seine, on pose la première pierre d'une cathédrale dont le chantier occupera plusieurs générations de bâtisseurs. |
| emoji | ⛪ |
| niveau | 2 |
...
|---|---|
| annee | 1202 |
| desc | Un marchand pisan publie un livre de calcul qui va convaincre l'Europe d'abandonner les chiffres romains. |
| emoji | 🔢 |
| niveau | 2 |
...
|---|---|
| annee | 1768 |
| desc | À Londres, un ancien cavalier militaire trace une piste ronde et y mélange voltige à cheval, acrobates et clowns. |
| emoji | 🎪 |
| niveau | 2 |
...
|---|---|
| annee | 1793 |
| desc | En pleine Révolution, le palais des rois de France devient un musée où chacun peut venir voir les chefs-d'œuvre des collections royales. |
| emoji | 🖼️ |
| niveau | 2 |
...
|---|---|
| annee | 1795 |
| desc | Fini les mesures qui changent d'une ville à l'autre : une loi crée une unité unique, calculée d'après la taille de la Terre elle-même. |
| emoji | 📏 |
| niveau | 2 |
...
|---|---|
| annee | 1795 |
| desc | Privé de graphite anglais par la guerre, un inventeur français mélange poudre de graphite et argile : le crayon tel qu'on le connaît est né. |
| emoji | ✏️ |
| niveau | 2 |
...
|---|---|
| annee | 1846 |
| desc | À Boston, devant des médecins ébahis, un patient endormi par un gaz est opéré sans un cri : la douleur n'est plus une fatalité. |
| emoji | 😴 |
| niveau | 2 |
...
|---|---|
| annee | 1859 |
| desc | Au sommet de la tour du Parlement de Londres, une cloche de plus de treize tonnes fait entendre sa voix grave pour la première fois. |
| emoji | 🕰️ |
| niveau | 1 |
...
|---|---|
| annee | 1863 |
| desc | Dans une taverne de Londres, des clubs se mettent d'accord sur des règles communes : interdiction de porter le ballon à la main, naissance d'un sport planétaire. |
| emoji | ⚽ |
| niveau | 2 |
...
|---|---|
| annee | 1870 |
| desc | À bord d'un sous-marin fabuleux commandé par le mystérieux capitaine Nemo, Jules Verne entraîne ses lecteurs au fond des océans. |
| emoji | 🐙 |
| niveau | 2 |
...
|---|---|
| annee | 1883 |
| desc | Un pantin de bois qui rêve de devenir un vrai petit garçon — et dont le nez s'allonge à chaque mensonge — paraît en Italie. |
| emoji | 🤥 |
| niveau | 1 |
...
|---|---|
| annee | 1889 |
| desc | À Naples, un pizzaïolo compose pour la reine d'Italie une pizza aux couleurs du drapeau : tomate, mozzarella, basilic. |
| emoji | 🍕 |
| niveau | 1 |
...
|---|---|
| annee | 1894 |
| desc | Un petit d'homme élevé par les loups, guidé par une panthère et un ours, grandit dans la jungle indienne sous la plume de Kipling. |
| emoji | 🐆 |
| niveau | 1 |
...
|---|---|
| annee | 1899 |
| desc | Un laboratoire allemand commercialise sous forme de poudre un remède contre la douleur et la fièvre, dérivé de l'écorce de saule. |
| emoji | 💊 |
| niveau | 2 |
...
|---|---|
| annee | 1914 |
| desc | À un carrefour de Cleveland, des lampes électriques rouges et vertes se mettent à régler la circulation à la place des agents. |
| emoji | 🚦 |
| niveau | 2 |
...
|---|---|
| annee | 1935 |
| desc | Un sismologue californien invente une échelle de chiffres pour comparer la force des tremblements de terre. |
| emoji | 📈 |
| niveau | 2 |
...
|---|---|
| annee | 1998 |
| desc | Un bébé minuscule, plus malin que les grands, affronte la sorcière Karaba dans un dessin animé inspiré des contes d'Afrique de l'Ouest. |
| emoji | 👶 |
| niveau | 1 |
...
## Ce que ce lot change, s'il est validé en entier

| Mesure | Avant | Après |
|---|---|---|
| Faits de niveau 1 | 191 | 204 |
| Pack Asie — faits N1 / N2 | 2 / 32 | 7 / 39 |
| Pack Asie — parties Normal composables | 0 | 2 |
| Pack Afrique — faits N1 / N2 | 6 / 53 | 7 / 59 |
| Sciences — faits N1 | 24 | 27 |
| Le test des packs (seuil 8) | passe | passe (inchangé : le goulot est le Difficile) |

C'est un premier pas, pas la solution : pour que « Facile » existe vraiment
dans les packs, il faudra plusieurs lots comme celui-ci. Le suivant pourra
viser les niveaux 1 purs (le critère est exigeant : Naruto oui, le Grand
Bouddha de Nara non) et les époques creuses d'avant 1500.
